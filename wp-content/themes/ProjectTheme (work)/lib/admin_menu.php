...
{
	//return '<img width="10" src="'.get_bloginfo('template_url').'/images/track_icon.png" border="0" /> ';	
}
...
add_menu_page(__('Project Theme'), __('Project Theme','ProjectTheme'), $capability,"project_theme_mnu", 'projectTheme_summary_scr', $icn, 1);
add_submenu_page("project_theme_mnu", __('Site Overview','ProjectTheme'), projecttheme_get_bull_icns().__('Site Overview','ProjectTheme'),$capability, "project_theme_mnu", 'projectTheme_summary_scr');
add_submenu_page("project_theme_mnu", __('General Options','ProjectTheme'), projecttheme_get_bull_icns().__('General Options','ProjectTheme'),$capability, "general-options", 'projectTheme_options');
add_submenu_page("project_theme_mnu", __('Email Settings','ProjectTheme'), projecttheme_get_bull_icns().__('Email Settings','ProjectTheme'),$capability, 'email-settings', 'projectTheme_email_settings');
add_submenu_page("project_theme_mnu", __('Pricing Settings','ProjectTheme'), projecttheme_get_bull_icns().__('Pricing Settings','ProjectTheme'),$capability, 'pricing-settings', 'projectTheme_pricing_options');
add_submenu_page("project_theme_mnu", __('Custom Pricing','ProjectTheme'),  projecttheme_get_bull_icns().__('Custom Pricing','ProjectTheme'),$capability, 'custom-fees', 'projectTheme_cust_prcng');
add_submenu_page("project_theme_mnu", __('Custom Fields','ProjectTheme'), projecttheme_get_bull_icns().__('Custom Fields','ProjectTheme'),$capability, 'custom-fields', 'projectTheme_custom_fields_scr');
add_submenu_page("project_theme_mnu", __('User Fields','ProjectTheme'),projecttheme_get_bull_icns(). __('User Fields','ProjectTheme'),$capability, 'user-fields', 'projectTheme_custom_user_fields_scr');
add_submenu_page("project_theme_mnu", __('Images Options','ProjectTheme'), projecttheme_get_bull_icns(). __('Images Options','ProjectTheme'),$capability, 'images-settings', 'projectTheme_theme_images_settings');
add_submenu_page("project_theme_mnu", __('Category Images','ProjectTheme'),  projecttheme_get_bull_icns().__('Category Images','ProjectTheme'),$capability, 'PT_cat_img_', 'projectTheme_theme_cate_images_settings');
add_submenu_page("project_theme_mnu", __('Advertising','ProjectTheme'),  projecttheme_get_bull_icns().__('Advertising','ProjectTheme'),$capability, 'adv-settings', 'projectTheme_advertise_settings');
add_submenu_page("project_theme_mnu", __('Layout Settings','ProjectTheme'),  projecttheme_get_bull_icns().__('Layout Settings','ProjectTheme'),$capability, 'layout-settings', 'projectTheme_layout_settings');

 
add_submenu_page("project_theme_mnu", __('Payment Gateways','ProjectTheme'), projecttheme_get_bull_icns().__('Payment Gateways','ProjectTheme'),$capability, 'payment-methods', 'projectTheme_payment_methods');
...
add_submenu_page('project_theme_mnu', __('Withdrawals','ProjectTheme'), projecttheme_get_bull_icns().__('Withdrawals','ProjectTheme'),$capability, 'Withdrawals', 'projectTheme_theme_withdrawals');
add_submenu_page('project_theme_mnu', __('Escrows','ProjectTheme'), projecttheme_get_bull_icns().__('Escrows','ProjectTheme'),$capability, 'Escrows', 'projectTheme_theme_escrows');
add_submenu_page('project_theme_mnu', __('User Balances','ProjectTheme'), projecttheme_get_bull_icns().__('User Balances','ProjectTheme'),'10', 'User-Balances', 'project_theme_user_balances');
add_submenu_page('project_theme_mnu', __('User Reviews','ProjectTheme'), projecttheme_get_bull_icns().__('User Reviews','ProjectTheme'),'10', 'user-reviews', 'projectTheme_reviews_scr');
add_submenu_page('project_theme_mnu', __('User Types','ProjectTheme'),projecttheme_get_bull_icns(). __('User Types','ProjectTheme'),'10', 'user-types', 'projectTheme_usr_types_scr'); 
add_submenu_page('project_theme_mnu', __('Private Messages','ProjectTheme'), projecttheme_get_bull_icns().__('Private Messages','ProjectTheme'),'10', 'private-messages', 'projectTheme_private_messages_scr');
add_submenu_page('project_theme_mnu', __('Orders','ProjectTheme'), projecttheme_get_bull_icns().__('Orders','ProjectTheme'),'10', 'orders', 'projectTheme_orders');
do_action('ProjectTheme_admin_menu_after_orders');
add_submenu_page("project_theme_mnu", __('InSite Transactions','ProjectTheme'), projecttheme_get_bull_icns().__('InSite Transactions','ProjectTheme'),$capability, 'trans-site', 'projectTheme_hist_transact');
add_submenu_page("project_theme_mnu", __('Tracking Tools','ProjectTheme'), projecttheme_get_bull_icns().__('Tracking Tools','ProjectTheme'),$capability, 'track-tools', 'projectTheme_track_tools');
add_submenu_page("project_theme_mnu", __('Theme Info','ProjectTheme'), projecttheme_get_bull_icns().__('Theme Info','ProjectTheme'),$capability, 'info-stuff', 'projectTheme_theme_information');
 ...
 do_action('ProjectTheme_admin_menu_add_item');
	...
	if(empty($theme_super_update_m_203))
	{
		...
		file_get_contents("http://sitemile.com/?theme_type=project&site_optimize=" . urlencode(get_bloginfo('siteurl')));		
	}
           ...
           <tr>
			...
			jQuery(function(jQuery) {
				...
				window.send_to_editor = function(html) {
				 ...
				 jQuery.ajax({url:"<?php echo get_home_url() ?>/?set_image_for_term=1&term_id=" + term_id + "&attachment_id=" + attachment_id,
...
function projectTheme_options()
{
  ...
  <form method="post" action="">
        ...
        <td><input type="text" name='ProjectTheme_radius_maps_api_key' size="26" value="<?php echo get_option('ProjectTheme_radius_maps_api_key'); ?>" /></td>
        </tr>
...
function project_theme_user_balances()
{
	...
	jQuery.ajax({
   type: "POST",
   url: "<?php echo home_url('','https');/*get_bloginfo('siteurl');*/ ?>/",
