		...
		$terms = get_terms("project_cat","parent=0&hide_empty=0");
		 ...
		 if ( $count > 0 ){
			...
			$stuffy = '';
			   	...
			   	if($terms2){
			   		$parr="<a href='#' class='parent_taxe' rel='taxe_project_cat_".$term->term_id."' ><img rel='img_taxe_project_cat_".$term->term_id."'
				...
				$mese = '';
					...
					$mese .= '<ul>';
					$mese .= $parr."<h3><a href='".get_term_link($term,"project_cat")."'>" . $term->name;
