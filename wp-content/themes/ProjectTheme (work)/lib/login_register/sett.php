...
function my_retrieve_password()
{
	...
	$message = __('<img id="logo" alt="BidQA" src="bidqa.com/wp-content/themes/ProjectTheme/images/logo/imgo.jpeg"><br>Hello! You have requested to reset your password for the following account:', $current_theme_locale_name) . "\n<br>";
	...
	$message .= '' . get_bloginfo('url')."/wp-login.php?action=rp&key=$key&login=" . rawurlencode($user_login) . "\n<br>";
