...
***************************************************************************/
		...
		get_currentuserinfo();
 		...
 		if($_GET['curent_comment']){$curent_comment=$_GET['curent_comment'];} 		
 ...
 ?> 
                 ...
                 <div class="page_heading_me">
                        <div class="page_heading_me_inner">
                            <div class="mm_inn"> <?php printf(__("Review User %s for project %s",'ProjectTheme'), $user->user_login, $post_pr->post_title ) ; ?> </div>
...
<div id="main_wrapper">
 ...
 <div id="content" class="account-main-area">
        ...
        <form method="post">	
        	...
        	<p><select class="do_input" name="rating"><?php for($i=5;$i>0;$i--) {$cur_raiting==($i*2) ? $a="selected" : $a="";echo '<option value="'.($i*2).'" '.$a.'>'.$i.'</option>';} ?></select></p>
        </li>
        
        <li>
        	<h2><?php echo __('Your Comment','ProjectTheme'); ?>:</h2>
        	<p><textarea name="commenta" class="do_input" rows="5" cols="40" ><?php echo strip_tags($curent_comment); ?></textarea></p>
        </li>
