...
function check_submits()
{
	...
	if( jQuery("#bid").val() < 0 ) 
	{
		alert("<?php _e('Please type a positive value.','ProjectTheme'); ?>");
		return false;	
	}
                ...
                <input type="hidden" name="control_id" value="<?php echo base64_encode($pid); ?>" /> 
                	<ul class="project-details" style="width:100%">
                            ...
                            <li>
								...
								<p> 
                                <input type="number" min="1" name="bid" id="bid" class="bid_field" value="<?php echo $bid; ?>" size="10" onkeyup="validate(this)" /> 
                                <?php 
