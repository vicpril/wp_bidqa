...
?>
    ...
    $.post("<?php bloginfo('siteurl'); ?>/?get_message_board=<?php echo $pid; ?>",        // PERFORM AJAX POST
      { sumbit_message: "1", my_message: My_NEW_MESS   }
	  , function(data) { 
	  
	  $("#my-message-stuff").prepend(data);
	  $("#my_messages").val("");
    ...
    ?>
                ...
                <input type="hidden" name="control_id" value="<?php echo base64_encode($pid); ?>" /> 
                	<ul class="project-details" style="width:430px">
                            ...
                            <li>
								<h3>&nbsp</h3>
								<p><input type="hidden" name="control_id" value="<?php echo base64_encode($pid); ?>" />
      ...
      <?php       
		   ...
		   ?>  
			 ...
			 $sh = "select * from ".$wpdb->prefix."project_message_board where pid='$pid' order by datemade desc";
