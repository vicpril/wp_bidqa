 <?php
	...
	function PricerrTheme_filter_ttl($title){return __("Activate job",'PricerrTheme')." - ";}
...
//-----------------------------------------------------------------------------------------------
        ...
        <div id="content">
        	<div class="padd10">
            	...
            	<div class="box_title"><?php echo sprintf(__("Activate Job - %s", 'PricerrTheme'), $title); ?></div>
 ...
 <?php
                ...
                <input type="submit" name="are_you_sure2" value="<?php _e("Confirm Activation", 'PricerrTheme'); ?>"  />
                </form>
