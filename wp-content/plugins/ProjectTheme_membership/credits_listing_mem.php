...
?>
        ...
        <div class="page_heading_me">
                        <div class="page_heading_me_inner">
                            <div class="mm_inn"><?php _e("Pay Membership by Virtual Currency", "ProjectTheme"); ?>  </div>
...
<div id="main_wrapper">
                ...
                <?php
					...
					if(isset($_GET['pay'])):
						echo '<div class="details_holder sk_sk_class">';
							...
							if($cr < $amount) { echo '<div class="error2">'; echo __('You do not have enough credits to pay for membership.','ProjectTheme');
							...
							else
							{
								...
								//{
									...
									if(empty($projectTheme_monthly_nr_of_projects)) $projectTheme_monthly_nr_of_projects = 10;
								...
								echo sprintf(__('Your payment has been sent. Return to <a href="%s">your account</a>.','ProjectTheme'), get_permalink(get_option('ProjectTheme_my_account_payments_id')) );	
							}
							echo '</div>';
				?>
	...
	?>
               ...
               <a class="post_bid_btn" href="<?php echo get_bloginfo('siteurl'); ?>/?p_action=credits_listing_mem&pid=<?php echo $pid; ?>&pay=yes"><?php echo __('Pay Now','ProjectTheme'); ?></a> 
