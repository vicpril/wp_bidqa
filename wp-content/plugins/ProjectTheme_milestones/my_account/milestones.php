...
?>
        ...
        <form method="post" action="<?php echo get_permalink(get_option('ProjectTheme_my_account_milestones_id')) ?>">
               ...
               <tr>
                    ...
                    <td><input type="text" size="15" id="amount_text" name="amount_text" pattern="^\d+(\.|\,)\d{2}" placeholder="00.00" value="<?php echo isset($amount_text) ? $amount_text : ''; ?>" /> <?php echo projecttheme_get_currency() ?> </td> 
               </tr>
					...
					if(count($r) > 0)
					{
                        ...
                        <table class="bdd_bdd" width="100%">
                        	<tr>
                                ...
                                <td><?php _e('Project Owner','ProjectTheme'); ?></td>
                                <td><?php _e('Amount','ProjectTheme'); ?></td>
						...
						?>
                				<tr>
                                    ...
                                    <td><?php echo '<a href="'.ProjectTheme_get_user_profile_link($user_of_milestone->ID).'">'.$user_of_milestone->first_name.'</a>' ?></td>
